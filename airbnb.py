...
def datafr():
    df= pd.read_csv("E:\GUVI\projects\AirBnB\data\Airbnb.csv")
    return df
...
if select == "Home":
    ...
    image1= Image.open("E:\GUVI\projects\AirBnB\images\Airbnb image.jpg")
    st.image(image1)
...
if select == "Data Exploration":
    ...
    with tab2:
        ...
        def datafr():
            df_a= pd.read_csv("E:\GUVI\projects\AirBnB\data\Airbnb.csv")
            return df_a
